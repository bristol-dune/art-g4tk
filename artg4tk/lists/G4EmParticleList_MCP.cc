...
//---------------------------------------------------------------------------
//
// ClassName:   G4EmParticleList_MCP 
//
...
G4EmParticleList_MCP::G4EmParticleList_MCP() 
{
  pNames = 
    { 
        "gamma",            "e-",           "e+",           "mu+",        "mu-",
...
"anti_sigma_c+","anti_sigma_c++",  "anti_sigma+",   "anti_sigma-","anti_triton",
   "anti_xi_c+",      "anti_xi-",     "deuteron",     "lambda_c+",     "omega-",
	 ...
	 "tau-",        "triton",        "xi_c+",           "xi-",        "Bc+",
	  ...
	  "anti_sigma_b+", "anti_sigma_b-",        "xi_b-",    "anti_xi_b-", "MCPPlus"
    };
}
...
const std::vector<G4String>& G4EmParticleList_MCP::PartNames() const
{
  return pNames;
}
