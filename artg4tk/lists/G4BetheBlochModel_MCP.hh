...
#ifndef G4BetheBlochModel_MCP_h
#define G4BetheBlochModel_MCP_h 1
...
class G4BetheBlochModel_MCP : public G4VEmModel
{

public:

  explicit G4BetheBlochModel_MCP(const G4ParticleDefinition* p = nullptr,
                               const G4String& nam = "MCPBetheBloch");

  ~G4BetheBlochModel_MCP() override = default;
  ...
  G4BetheBlochModel_MCP & operator=(const  G4BetheBlochModel_MCP &right) = delete;
  G4BetheBlochModel_MCP(const  G4BetheBlochModel_MCP&) = delete;
