...
//---------------------------------------------------------------------------
//
// ClassName:   G4EmStandardPhysics_MCP
//
...
#include "G4EmStandardPhysics_MCP.hh"
...
#include "artg4tk/particles/G4MCPPlus.hh"
...
//
G4_DECLARE_PHYSCONSTR_FACTORY(G4EmStandardPhysics_MCP);
...
G4EmStandardPhysics_MCP::~G4EmStandardPhysics_MCP()
{}

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......

void G4EmStandardPhysics_MCP::ConstructParticle()
{
  // gamma
  G4Gamma::Gamma();
...
void G4EmStandardPhysics_MCP::ConstructProcess()
{
  if(verbose > 1) {
  ...
  for(const auto& particleName : partList.PartNames()) {
	...
	ph->RegisterProcess(new G4RayleighScattering(), particle);
      ...
      ph->RegisterProcess(hmsc, particle);
      ph->RegisterProcess(new G4hIonisation(), particle);
    } else if (particleName == "MCPPlus") {
      ph->RegisterProcess(mumsc, particle);
      ph->RegisterProcess(new G4MCPIonisation(), particle);
      ph->RegisterProcess(mub, particle);
      ph->RegisterProcess(mup, particle);
      ph->RegisterProcess(muss, particle);
    }
