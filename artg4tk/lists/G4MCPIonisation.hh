...
#ifndef G4MCPIonisation_h
#define G4MCPIonisation_h 1
...
class G4MCPIonisation : public G4VEnergyLossProcess
{

public:

  explicit G4MCPIonisation(const G4String& name = "muIoni");

  ~G4MCPIonisation() = default;
...
private:
  ...
  G4MCPIonisation & operator=(const G4MCPIonisation &right) = delete;
  G4MCPIonisation(const G4MCPIonisation&) = delete;
